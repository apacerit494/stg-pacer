...
class Certificant extends BaseController
{
    ...
    {
        $data['title'] = 'Certificant';
        $data["breadcrumbs"] = ['Pengelolaan Certificant', 'Certificant'];
        $data["icon"] = "bx-user-circle";
        $data["no"]     = 0;
        $data['provinces'] = $this->BaseModel->get_provinces();
        $data['user_types'] = $this->BaseModel->get_user_types();
        $data['menu'] = $this->generate_menu('/Certificant/index');
        ...
        $data['departement_ids'] = $this->BaseModel->get_select_master_code('departement_id');
        $data['provinces'] = $this->BaseModel->get_provinces();
        $data['districts'] = array(); //$this->BaseModel->get_districts('aflkahdfldkf');
        $data['subdistricts'] = array(); //$this->BaseModel->get_subdistricts('lahfkhakfa');
        $data['villages'] = array(); //$this->BaseModel->get_villages('bakfdbasfasf');
        $data['user_types'] = $this->BaseModel->get_user_types();
        ...
        return view('Certificant/Main', $data);
    }
    ...
    public function jqgrid_user()
    {
        ...
        $result = $this->CertificantModel->jqgrid_user('', '', '', '', $tipe_keyword, $keyword);
        ...
        $result = $this->CertificantModel->jqgrid_user($sidx, $sord, $limit_rows, $start, $tipe_keyword, $keyword);
        ...
        if ($valid == true) {
            ...
            try {
                ...
                $data = array(
                    ...
                    $id == "" ? 'created_at' : 'updated_at' => $updatedAt
                );
            } catch (\Exception $e) {
                $file_exists = false;
                $data = array(
            ...
            //dd($data);
            $this->db->transbegin();
            $id == "" ? $this->CertificantModel->insert_personal($data) : $this->RegisterModel->update_personal($data, $id);
            if ($this->db->transstatus() === true) {
                $this->db->transcommit();
                if ($id == "") {
                    $new_id = $this->CertificantModel->get_id($email);
                } else {
                    $new_id = $id;
                }
                $return = array('success' => true, 'user_id' => $new_id, 'old_password' => $password, 'baru' => $id == '' ? 'baru' : 'lama');
            } else {
    ...
    public function add_education($jumlah_education)
    {
        ...
        if (!$this->validasi_education($jumlah_education)) {
            ...
            $check_scoring = $this->CertificantModel->check_scoring(user_id());
            if ((intval($check_scoring) % 4) > 0) {
                ...
                if ($this->db->transstatus() === true) {
                    ...
                    $this->db->transrollback();
                    $return = array('success' => false, 'msg' => 'Failed to connect database!');
                }
            }
        }
    ...
    function add_user()
    {
        ...
        if ($check['success'] == false) {
            ...
            $this->db->transbegin();
            $this->CertificantModel->insert_user($data);
            if ($this->db->transstatus() === true) {
                $this->db->transcommit();
                $return = array('success' => true);
            } else {
    ...
    {
        $id = $this->request->getVar('id');
        $data = $this->CertificantModel->get_data_user_by_id($id);
    ...
    {
        $id = $this->request->getVar('id');
        $data = $this->CertificantModel->check_status_certification_by_id($id);
    ...
    {
        $id = $this->request->getVar('id');
        $data = $this->CertificantModel->get_data_education_by_id($id);
        echo json_encode($data);
    }
    ...
    {
        $id = $this->request->getVar('id');
        $data = $this->CertificantModel->get_data_experience_by_id($id);
        echo json_encode($data);
    }
    ...
    {
        $id = $this->request->getVar('id');
        $data = $this->CertificantModel->get_data_audit_experience_by_id($id);
        echo json_encode($data);
    }
    ...
    {
        $id = $this->request->getVar('id');
        $data = $this->CertificantModel->get_data_training_by_id($id);
        echo json_encode($data);
    }
    ...
    function edit_user()
    {
        ...
        if ($check['success'] == false) {
            ...
            $this->db->transbegin();
            $this->CertificantModel->update_user($data, $id);
            if ($this->db->transstatus() === true) {
                $this->db->transcommit();
                $return = array('success' => true);
            } else {
    ...
    public function get_select()
    {
        ...
        $data = $this->CertificantModel->get_select($table);
    ...
    public function get_child()
    {
        ...
        $data = $this->CertificantModel->get_child($table, $id);
        return json_encode($data);
    }
    ...
    {
        $data['title'] = 'Upload Certificant';
        $data["breadcrumbs"] = ['Pengelolaan Certificant', 'Upload Certificant'];
        $data["icon"] = "bx-user-circle";
        $data['notifications'] = $this->BaseModel->get_notifications(user()->user_type_id == '2' ? '0' : user_id());
        $data["no"]     = 0;
        $data['menu'] = $this->generate_menu('/Certificant/upload_user');
        return view('Certificant/Upload_user', $data);
    }
