<!-- Awal form detail -->
<div class="card card-info" id="detail" style="display: none;">
    ...
    <div class="card-body">
        <form class="form-horizontal" role="form" method="post" id="FormDetail" action="<?php echo site_url('Scoring/detail_scoring') ?>">
            <?= csrf_field() ?>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="education_score" id="education_score" class="form-control" style="text-align:right" maxlength="3" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-4 control-label" style="text-align:right">Training Score</label>
                            <div class="col-sm-4">
                                <input type="text" name="training_score" id="training_score" class="form-control" style="text-align:right" maxlength="3" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-4 control-label" style="text-align:right">Audit Experience Score</label>
                            <div class="col-sm-4">
                                <input type="text" name="audit_experience_score" id="audit_experience_score" class="form-control" style="text-align:right" maxlength="3" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-4 control-label" style="text-align:right">Experience Score</label>
                            <div class="col-sm-4">
                                <input type="text" name="experience_score" id="experience_score" class="form-control" style="text-align:right" maxlength="3" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-4 control-label" style="text-align:right">Write Exam Score</label>
                            <div class="col-sm-4">
                                <input type="text" name="written_exam_score" id="written_exam_score" class="form-control" style="text-align:right" maxlength="3" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-8">
                                <input class="form-control" type="file" id="written_exam_path" name="written_exam_path" accept="image/jpeg,image/gif,image/png,application/pdf,image/x-eps" readonly>
                            </div>
                            <div class="com-sm-4">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="pratical_exam_score" id="pratical_exam_score" class="form-control" style="text-align:right" maxlength="3" readonly>
                            </div>
                           
                        </div>
                        <div class="form-group row">
                             <div class="col-sm-8">
                                <input class="form-control" type="file" id="practical_exam_path" name="practical_exam_path" accept="image/jpeg,image/gif,image/png,application/pdf,image/x-eps" readonly>
                            </div>
                            <div class="com-sm-4">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="observation_score" id="observation_score" class="form-control" style="text-align:right" maxlength="3" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                             <div class="col-sm-8">
                                <input class="form-control" type="file" id="observation_path" name="observation_path" accept="image/jpeg,image/gif,image/png,application/pdf,image/x-eps" readonly>
                            </div>
                            <div class="com-sm-4">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="total_score" id="total_score" class="form-control" style="text-align:right; background-color:lightgreen" maxlength="5" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <select name="scope_score" id="scope_score" class="form-control" readonly>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <select class="form-control" data-placeholder="Silahkan pilih level auditor " id="level_auditor" name="level_auditor" readonly>
                        ...
                        <?php if (user()->user_type_id == '1' || user()->user_type_id == '2') { ?>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" name="committee_score" id="committee_score" class="form-control" style="text-align:right" readonly>
                                </div>
                            </div>
                        <?php } ?>
                        <div class="form-group row">
