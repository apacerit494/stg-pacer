                            ...
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="text-muted">
                                        ...
                                        <span class="tag tag-warning"><?= $user['village_name']; ?></span><br>
                                            ...
                                            <div class="post">
                                                ...
                                                <?php foreach ($educations as $education) : ?>
                                                    <div class="user-block">
                                                        ...
                                                        <span class="description"><?= $education['start_date'] . ' s/d ' . $education['end_date']; ?></span>
                                                    </div>
                                                    <table>
                                                        <tr>
                                                            <td>Level&nbsp </td>
                                            ...
                                            <div class="post">
                                                ...
                                                <?php foreach ($experiences as $experience) : ?>
                                                    <div class="user-block">
                                                        ...
                                                        <span class="description"><?= $experience['start_date'] . ' s/d ' . $experience['end_date']; ?></span>
                                                    </div>
                                                    <table>
                                                        <tr>
                                            ...
                                            <div class="post">
                                                ...
                                                <?php foreach ($audits as $audit) : ?>
                                                    <div class="user-block">
                                                        ...
                                                        <span class="description"><?= $audit['start_date'] . ' s/d ' . $audit['end_date']; ?></span>
                                                    </div>
                                                    <table>
                                                        <tr>
                                            ...
                                            <div class="post">
                                                ...
                                                <?php foreach ($trainings as $training) : ?>
                                                    <div class="user-block">
                                                        ...
                                                        <span class="description"><?= $training['start_date'] . ' s/d ' . $training['end_date']; ?></span>
                                                    </div>
                                                    <table>
                                                        <tr>
                                            ...
                                            <div class="post">
                                                ...
                                                <?php foreach ($certifications as $certification) : ?>
                                                    <div class="user-block">
                                                        <img class="img-circle img-bordered-sm" src="../../dist/img/user1-128x128.jpg" alt="user image">
                                                        <span class="username">
                                                            <a href="#"><?= $certification['apply_date']; ?></a>
                                                        </span>
                                                    </div>
                                                    <table>
                                                        <tr>
