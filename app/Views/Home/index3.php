                        ...
                        <nav class="navbar navbar-default">
                            ...
                            <div class="navbar-header">
                                ...
                                <a class="navbar-brand page-scroll sticky-logo" href="index.html">
                                    ...
                                    <!-- <img src="<?= base_url(); ?>/assets/images/logo.png" alt="" title="" style="width : 50px;"> -->
                            ...
                            <div class="collapse navbar-collapse main-menu bs-example-navbar-collapse-1" id="navbar-example">
                                <ul class="nav navbar-nav navbar-right">
                                    ...
                                    <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Curriculum<span class="caret"></span></a>
                                        <ul class="dropdown-menu" role="menu">
                                            <li><a href=#>ISO 9001:2015</a></li>
                                            <li><a href=#>ISO 27001:2013</a></li>
                                            <li><a href=#>ISO 45001</a></li>
                                            <li><a href=#>ISO 22000 :2018</a></li>
    ...
    <div id="home" class="slider-area">
        <div class="bend niceties preview-2">
            <div id="ensign-nivoslider" class="slides">
                <img src="<?= base_url(); ?>/assets/front-end/img/slider/slider1.jpg" alt="" title="#slider-direction-1" />
                <img src="<?= base_url(); ?>/assets/front-end/img/slider/slider2.jpg" alt="" title="#slider-direction-2" />
                <img src="<?= base_url(); ?>/assets/front-end/img/slider/slider3.jpg" alt="" title="#slider-direction-3" />
                <img src="<?= base_url(); ?>/assets/front-end/img/slider/slider4.jpg" alt="" title="#slider-direction-3" />
            </div>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="slider-content">
                                ...
                                <div class="layer-1-2 wow slideInUp" data-wow-duration="2s" data-wow-delay=".1s">
                                    <h1 class="title2">Menjadi Lembaga Sertifikasi terbaik di Indonesia</h1>
                                </div>
                                <!-- layer 3 -->
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="slider-content text-center">
                                ...
                                <!-- layer 2 -->
                                <div class="layer-1-2 wow slideInUp" data-wow-duration="2s" data-wow-delay=".1s">
                                    <h1 class="title2">Memberikan pelayanan terbaik melalui penerapan sistem manajemen
                                        berbasis teknologi informasi</h1>
                                </div>
                                <!-- layer 3 -->
                                <div class="layer-1-3 hidden-xs wow slideInUp" data-wow-duration="2s" data-wow-delay=".1s">
                                    <a class="ready-btn right-btn page-scroll" href="#services">See Services</a>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="slider-content">
                                <!-- layer 1 -->
                                <div class="layer-1-1 hidden-xs wow slideInDown" data-wow-duration="2s" data-wow-delay=".1s">
                                    <h2 class="title1">MOTO</h2>
                                </div>
                                <!-- layer 2 -->
                                <div class="layer-1-2 wow slideInUp" data-wow-duration="2s" data-wow-delay=".1s">
                                    <h1 class="title2">Professional, Active, Care, Efective, Reliable</h1>
                                </div>
                                <!-- layer 3 -->
                                <div class="layer-1-3 hidden-xs wow slideInUp" data-wow-duration="2s" data-wow-delay=".1s">
                                    <a class="ready-btn right-btn page-scroll" href="#services">See Services</a>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="slider-content">
                                <!-- layer 1 -->
                                <div class="layer-1-1 hidden-xs wow slideInUp" data-wow-duration="1s" data-wow-delay=".1s">
                                    <h2 class="title1">MOTO</h2>
                                </div>
                                <!-- layer 2 -->
                                <div class="layer-1-2 wow slideInUp" data-wow-duration="1s" data-wow-delay=".1s">
                                    <h1 class="title2">Professional, Active, Care, Efective, Reliable</h1>
                                </div>
                                <!-- layer 3 -->
                                <div class="layer-1-3 hidden-xs wow slideInUp" data-wow-duration="1s" data-wow-delay=".1s">
                                    <a class="ready-btn right-btn page-scroll" href="#services">See Services</a>
                                    <a class="ready-btn page-scroll" href="#about">Learn More</a>
                                </div>
                            </div>
                    ...
                    <div class="well-middle">
                        <div class="single-well">
                            ...
                            <p style="text-align: justify;">
                                ...
                                Standar Kompetensi dari Audtor Sistem Manajemen di LSP PACER ditetapkan dalamSkema Sertifikasi yang ditetapkan oleh Komite Skema dan Ketidakberpihakan. Anggota KomiteSkema dan Ketidakberpihakan berasal dari pihak – pihak yang berkepentingan seperti dariPemerintah, Swasta atau Industri, Akademisi, Praktisi, Lembaga Sertifikasi, serta LembagaPelatihan. Skema Sertifikasi auditor sistem manajemen ini mengacu pada PeraturanPerundangan, Standar Nasional Indonesia terutama SNI ISO 19011, pengalaman terbaik (bestpractice) terkait kompetensi auditor dan sumber – sumber lain yang telah dikaji dan ditetapkanoleh Komite Skema dan Ketidakberpihakan..
                            </p>
                ...
                <div class="team-top">
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <div class="single-team-member">
                            <div class="team-img">
                                <a href="#">
                                    <img src="<?= base_url(); ?>/assets/front-end/img/team/1.jpg" alt="">
                                </a>
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <div class="single-team-member">
                            <div class="team-img">
                                <a href="#">
                                    <img src="<?= base_url(); ?>/assets/front-end/img/team/2.jpg" alt="">
                                </a>
                                <div class="team-social-icon text-center">
                                    <ul>
                                        <li>
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <div class="single-team-member">
                            <div class="team-img">
                                <a href="#">
                                    <img src="<?= base_url(); ?>/assets/front-end/img/team/3.jpg" alt="">
                                </a>
                                <div class="team-social-icon text-center">
                                    <ul>
                                        <li>
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <div class="single-team-member">
                            <div class="team-img">
                                <a href="#">
                                    <img src="<?= base_url(); ?>/assets/front-end/img/team/4.jpg" alt="">
                                </a>
                                <div class="team-social-icon text-center">
                                    <ul>
                                        <li>
                            ...
                            <div class="awesome-img">
                                ...
                                <div class="add-actions text-center">
                                    <div class="project-dec">
                                        <a class="venobox" data-gall="myGallery" href="<?= base_url(); ?>/assets/front-end/img/portfolio/1.jpg">
                                            <h4>Business City</h4>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12 photo">
                        <div class="single-awesome-project">
                            <div class="awesome-img">
                                ...
                                <div class="add-actions text-center">
                                    <div class="project-dec">
                                        <a class="venobox" data-gall="myGallery" href="<?= base_url(); ?>/assets/front-end/img/portfolio/2.jpg">
                                            <h4>Blue Sea</h4>
                                            <span>Photosho</span>
                                        </a>
                                    </div>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12 design">
                        <div class="single-awesome-project">
                            <div class="awesome-img">
                                ...
                                <div class="add-actions text-center">
                                    <div class="project-dec">
                                        <a class="venobox" data-gall="myGallery" href="<?= base_url(); ?>/assets/front-end/img/portfolio/3.jpg">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12 photo development">
                        <div class="single-awesome-project">
                            <div class="awesome-img">
                                ...
                                <div class="add-actions text-center">
                                    <div class="project-dec">
                                        <a class="venobox" data-gall="myGallery" href="<?= base_url(); ?>/assets/front-end/img/portfolio/4.jpg">
                                            <h4>Creative Team</h4>
                                            <span>Web design</span>
                                        </a>
                                    </div>
                        ...
                        <div class="single-awesome-project">
                            <div class="awesome-img">
                                ...
                                <div class="add-actions text-center text-center">
                                    <div class="project-dec">
                                        <a class="venobox" data-gall="myGallery" href="<?= base_url(); ?>/assets/front-end/img/portfolio/5.jpg">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12 design photo">
                        <div class="single-awesome-project">
                            <div class="awesome-img">
                                ...
                                <div class="add-actions text-center">
                                    <div class="project-dec">
                                        <a class="venobox" data-gall="myGallery" href="<?= base_url(); ?>/assets/front-end/img/portfolio/6.jpg">
                                            <h4>Night Hill</h4>
                                            <span>Photoshop</span>
                                        </a>
                                    </div>
