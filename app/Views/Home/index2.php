...
<head>
    ...
    <![endif]-->
    <link rel="shortcut icon" href="<?= base_url(); ?>/assets/admin/images/favicon-32x32.png">
        ...
        <div class="container">
            <div id="navbar" class="navbar navbar-default">
                ...
                <div class="collapse navbar-collapse">
                    ...
                    <div>
                        <a class="btn btn-primary" href="/Login/index" style="margin-top:22px;margin-left: 30px;">Login</a>
                    </div>
                </div>
            </div>
        </div>
