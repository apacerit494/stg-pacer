...
<div class="card card-info" id="add" style="display: none;">
    ...
    <div class="card-body">
        <form class="form-horizontal" role="form" method="post" id="FormAdd" action="<?php echo site_url('Voucher/add_voucher') ?>">
            ...
            <div class="form-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-3" style="margin-top:10px; ">
                        <input type="checkbox" id="unlimited" name="unlimited[]" style="color:blue"> Unlimited<br>
                    </div>
                </div>
                <div class="form-group row">
