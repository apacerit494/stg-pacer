...
<div class="card card-info" id="edit" style="display: none;">
    ...
    <div class="card-body">
        <form class="form-horizontal" role="form" method="post" id="FormEdit" action="<?php echo site_url('Scope/edit_scope') ?>">
            <?= csrf_field() ?>
            ...
            <div class="form-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-3">
                        <input type="text" name="scope_code" id="scope_code" class="form-control">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-2 control-label" style="text-align:right">Description</label>
                    <div class="col-sm-3">
                        <input type="text" name="scope_description" id="scope_description" class="form-control">
                    </div>
                </div>
