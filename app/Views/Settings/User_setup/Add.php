...
<div class="card card-info" id="add" style="display: none;">
    <div class="card-header">
        <h3 class="card-title">ADD USER SETUP</h3>
    </div>
    <!-- /.card-header -->
    <!-- form start -->

    <div class="card-body">
        <form class="form-horizontal" role="form" method="post" id="FormAdd" action="<?php echo site_url('Settings/add_user_setup') ?>">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="user_type_id" name="user_type_id" class="form-control" value="<?= old('role_id'); ?>">
                                    <option value="">Please Select</option>
