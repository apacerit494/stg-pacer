                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="border p-4 rounded">
                                    <div class="form-body">
                                        <form class="row g-3" method="POST" action="Login/authentication">
                                            <div class="col-12">
                                                <label for="inputUserName" class="form-label">Email</label>
                                                <input type="email" class="form-control<?= ($validation->hasError('username')) ? ' is-invalid' : ''; ?>" id="inputUserName" name="username" placeholder="Email" value="<?= old('username'); ?>">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="input-group" id="show_hide_password">
                                                    <input type="password" class="form-control border-end-0<?= ($validation->hasError('username')) ? ' is-invalid' : ''; ?>" name="password" id="inputChoosePassword" placeholder="Masukkan Password"> <a href="javascript:;" class="input-group-text bg-transparent"><i class='bx bx-hide'></i></a>
                                                </div>
                                            ...
                                            <div class="col-12">
                                                Don't have account? <a href="/Signup" class="text-center">Signup</a>
                                            </div>
                                        </form>
                                    </div>
                                </div>
