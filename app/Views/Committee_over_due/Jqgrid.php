...
<div class="card card-info" id="jqgrid">
    <div class="card-header">
        <h3 class="card-title">COMMITTEE OVER DUE</h3>
    </div>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <select class="form-control" id="tipe_keyword" name="tipe_keyword">
                                        <option value="d.full_name">Committee Name</option>
                                        <option value="f.full_name">Certificant Name</option>
                                    </select>
                                </div>
                                <div class="col-md-4">
            ...
            <div class="modal-dialog" style="width:800px;">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title"><i class="fa fa-print"></i> Re - Assignment</h4>
                    </div>
