                        ...
                        <div class="col-md-3">
                            ...
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="text-muted">
                                        <?= $user['birth_place'] . ', ' . date('d-m-Y', strtotime($user['birth_date'])); ?>
                                    </p>
                                    ...
                                    <div class="com-sm-2">
                                        <a id="btn_preview" class="btn btn-primary" href="<?= $user['doc_idcard_path'] == '' || $user['doc_idcard_path'] == null ? 'javascript:' : base_url() . $user['doc_idcard_path'] . "#toolbar=0" ?>" target="_blank">Preview</a>
                                    </div>
                                </div>
                                <!-- /.card-body -->
                            </div>
                                                ...
                                                <?php foreach ($educations as $education) : ?>
                                                    ...
                                                    <table>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="com-sm-2">
                                                                    : <a id="btn_preview_<?= $no; ?>" class="btn btn-primary" href="<?= $education['doc_path'] == '' || $education['doc_path'] == null ? 'javascript:' : base_url() . $education['doc_path'] . "#toolbar=0" ?>" target="_blank">Preview</a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <!-- <tr>
                                                ...
                                                <?php foreach ($experiences as $experience) : ?>
                                                    ...
                                                    <table>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="com-sm-2">
                                                                    : <a id="btn_preview_<?= $no; ?>" name="btn_preview_<?= $no; ?>" class="btn btn-primary" href="<?= $experience['doc_path'] == '' || $experience['doc_path'] == null ? 'javascript:' :  base_url() . $experience['doc_path'] . "#toolbar=0"; ?>" target="_blank">Preview</a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                ...
                                                <?php foreach ($audits as $audit) : ?>
                                                    ...
                                                    <table>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>:</td>
                                                            <td>
                                                                <a id="btn_preview_audit_<?= $no; ?>" name="btn_preview_audit_<?= $no; ?>" class="btn btn-primary" href="<?= $audit['doc_audit_plan_path'] == '' || $audit['doc_audit_plan_path'] == null ? 'javascript:' : base_url() . $audit['doc_audit_plan_path'] . "#toolbar=0"; ?>" target="_blank">Preview</a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>:</td>
                                                            <td>
                                                                <a id="btn_preview_work_<?= $no; ?>" name="btn_preview_work_<?= $no; ?>" class="btn btn-primary" href="<?= $audit['doc_work_order_path'] == '' || $audit['doc_work_order_path'] == null ? 'javascript:' : base_url() . $audit['doc_work_order_path'] . "#toolbar=0"; ?>" target="_blank">Preview</a>
                                                            </td>
                                                        </tr>
                                                        <!-- <tr>
                                                            <td>Score&nbsp </td>
                                                ...
                                                <?php foreach ($trainings as $training) : ?>
                                                    ...
                                                    <table>
                                                        <tr>
                                                            ...
                                                            <td> :&nbsp <?= $training['training_topic']; ?> </td>
                                                        </tr>
                                                        <tr>
                                                            <td>Relation Status&nbsp </td>
                                                            <td> :&nbsp <?= $training['relation']; ?> </td>
                                                        </tr>
                                                        <tr>
                                                            <td>Certificate&nbsp </td>
                                                            <td>
                                                                <div class="com-sm-2">
                                                                    : <a id="btn_preview_<?= $no; ?>" name="btn_preview_<?= $no; ?>" class="btn btn-primary" href="<?= $training['doc_path'] == '' || $training['doc_path'] == null ? 'javascript:' : base_url() . $training['doc_path'] . "#toolbar=0" ?>" target="_blank">Preview</a>
                                                                </div>
                                                            </td>
                                                        </tr>
