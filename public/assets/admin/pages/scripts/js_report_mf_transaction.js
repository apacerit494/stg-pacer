...
$("#jqgrid_data").jqGrid({
    url: site_url+'/report/jqgrid_report_mf_transaction',
    mtype: "GET",
    datatype: "json",
    postData:{
        fund_code:function(){ return $('#fund_code').val() },
        mf_code:function(){ return $('#mf_code').val() },
    ...
    colModel: [
        ...
        ,{ label: 'Mutual Fund' , name: 'mf_name', width: 100, align:'left' }
        ...
        ,{ label: 'Total Unit' , name: 'quantity_unit', width: 100, align:'right',formatter:'currency', formatoptions: {decimalSeparator:',',thousandsSeparator:'.',decimalPlaces:0,defaultValue:'0' } }
...
$('#btn_export').click(function(){
    ...
    mf_code=($('#mf_code').val()=="")?'-':$('#mf_code').val();
    ...
    window.open(site_url+'excel/report_mf_transaction/'+tradedatefrom+'/'+tradedateto+'/'+fund_code+'/'+mf_code);
})
...
$('#btn_pdf').click(function(){
    ...
    window.open(site_url+'pdf/report_mf_transaction/'+tradedatefrom+'/'+tradedateto+'/'+fund_code+'/'+mf_code);
});
})