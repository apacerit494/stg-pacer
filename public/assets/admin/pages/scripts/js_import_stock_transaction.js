...
/*DATA PESERTA*/
jqgrid_data.jqGrid({
    url: site_url+'/outsourcing/jqgrid_import_stock_transaction',
    mtype: "GET",
    datatype: "json",
    postData: {
    ...
    colModel: [
        ...
        { label: 'Action', name:"filename", width: 200, align:'center', formatter: function(cellvalue,rowObj,rowArray) {
                ...
                var process_url = site_url+'/outsourcing/process_import_data_stock_transaction/'+row_id;
                var download_button = '<a class="btn btn-default btn-sm2" style="margin:5px 0;" href="'+base_url+'assets/admin/files/stock_transaction/'+cellvalue+'" title="'+cellvalue+'"><i class="fa fa-download"></i> &nbsp;Download</a>';
                var process_button = '<a class="btn btn-default btn-sm2" style="margin:5px 0;" href="'+process_url+'" title="Proses Import Transaksi Subscription"><i class="fa fa-refresh"></i> &nbsp;Process</a>';
...
$("a#btn-delete").livequery('click',function(){
    ...
    message = "Hapus Data Import Transaksi Subscription. Apakah anda yakin ?";
    ...
    $.confirm({
        ...
        confirm:function(){
            $.ajax({
                ...
                dataType:"json",data:{
                    import_id:id
                },url:site_url+"/outsourcing/delete_import_data_stock_transaction",
                success: function(response) {
