...
$("#jqgrid_data").jqGrid({
    url: site_url+'/inhouse/jqgrid_stock_portofolio',
    mtype: "GET",
    datatype: "json",
     postData:{ 
...
$('#btn_export').click(function(){
    ...
    window.open(site_url+'excel/export_report_stock_portofolio/'+fund_code+'/'+emiten)
})
...
$('#btn_pdf').click(function(){
    ...
    fund_code=(fund_code=="")?'-':fund_code;
    emiten=(emiten=="")?'-':emiten;
    window.open(site_url+'pdf/export_report_stock_portofolio/'+fund_code+'/'+emiten)
})
