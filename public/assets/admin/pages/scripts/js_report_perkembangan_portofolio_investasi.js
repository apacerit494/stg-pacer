$(function(){
    ...
    $('#btn_export').click(function(e){
        ...
        if (fund_code!="" && valuation_date!="-") {
            window.open(site_url+'excel/report_perkembangan_portofolio_investasi/'+valuation_date+'/'+fund_code);
        } else {
    ...
    $('#btn_pdf').click(function(e){
        ...
        valuation_date=(valuation_date=="")?"-":Template.ToDateDefault($('#valuation_date').val());
        if (fund_code!="" && valuation_date!="-") {
            window.open(site_url+'pdf/report_perkembangan_portofolio_investasi/'+valuation_date+'/'+fund_code);
        } else {
            Template.WarningAlert("The form not complete, please check again !");
        }
    });
