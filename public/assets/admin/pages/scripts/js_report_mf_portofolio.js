...
$("#jqgrid_data").jqGrid({
    url: site_url+'/report/jqgrid_report_mf_portofolio',
    mtype: "GET",
    datatype: "json",
     postData:{ 
    ...
    colModel: [
        ...
        ,{ label: 'Fund Manager' , name: 'fm_name', width: 250, align:'left' }
...
$('#btn_export').click(function(){
    ...
    window.open(site_url+'excel/report_mf_portofolio/'+fund_code+'/'+emiten)
})
...
$('#btn_pdf').click(function(){
    ...
    fund_code=(fund_code=="")?'-':fund_code;
    emiten=(emiten=="")?'-':emiten;
    window.open(site_url+'pdf/report_mf_portofolio/'+fund_code+'/'+emiten)
})
