...
/*DATA PESERTA*/
jqgrid_data.jqGrid({
    url: site_url+'outsourcing/jqgrid_import_data_stock_transaction',
    mtype: "GET",
    datatype: "json",
    postData:{
    ...
    colModel: [
        ...
        ,{label:'Securities Name',name:'securities_name',width:100,formatter:function(cellvalue,rowObj,rowArray){
            var flag_error_ticker=rowArray[7];
        ...
        ,{label:'Quantity',name:'quantity',width:120,align:'right',formatter:'currency', formatoptions: {decimalSeparator:',',thousandsSeparator:'.',decimalPlaces:0,defaultValue:'0' }}
...
btn_back.click(function(e){
    e.preventDefault();
    window.location.href=site_url+'/outsourcing/import_stock_transaction';
})
        ...
        $.confirm({
            ...
            confirm: function(){
                $.ajax({
                    ...
                    },url:site_url+'/outsourcing/do_import_data_stock_transaction',
                    success: function(response){
                        if (response.success==true) {
                            $.alert({
                                title:'Proses Transaksi Subscription SELESAI!',icon:'fa fa-check',backgroundDismiss:false,
