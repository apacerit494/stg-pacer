...
$('#btn_search').click(function(e){
    ...
    grid_verify.click(function(e){
        ...
        selarrrow = $('#jqgrid_data').jqGrid('getGridParam','selarrrow');
       // fund_group_code = $('#jqgrid_data').jqGrid('getGridParam','fund_group_code');
        //bank_code = $('#jqgrid_data').jqGrid('getGridParam','bank_code');
        //amount = $('#jqgrid_data').jqGrid('getGridParam','amount');
         //fund_group_code = $(this).data('fund_group_code');
        ...
        $.ajax({
          ...
          //  type:"POST",dataType:"json",data:{keyword:keyword,fund_group_code:fund_group_code,bank_code:bank_code,amount:amount},
            //type:"POST",dataType:"json",data:{keyword:keyword,fund_group_code:fund_group_code,bank_code:selarrrow,amount:selarrrow},
