$(document).ready(function () {
    ...
    $("#jqgrid_data").jqGrid({
        ...
        colModel: [
            ...
            {
                label: 'Action', name: 'status_id', width: 370, align: 'left', formatter: function (cellvalue, rowObj, rowArray) {
                    ...
                    if (user_type != '5') {
                        ...
                        upload_button = '<a href="" \
                                id="btn_upload" \
                                target="_blank" \
                                title="Upload Card & Certificate" \
                                class="btn btn-info btn-sm2" \
                                style="margin:5px 0;" \
                                data-certification_id="'+ certification_id + '" \
                                data-certification_card_path="'+ certification_card_path + '" \
                                data-certification_certificate_path="'+ certification_certificate_path + '" \
                           ><i class="fa fa-upload"></i> Upload</a>';

                    } else {
                        upload_button = '';
                    }
                    if (certification_card_path != '') {
                        download_card_button = '<a href="' + site_url + '/pdf/print_card' + '" \
                    ...
                    if (certification_certificate_path != '') {
                        download_certificate_button = '<a href="' + site_url + certification_card_path + '" \
                                    id="btn_download_card" \
                                    target="_blank" \
                    ...
                    var actions = upload_button + ' ' + download_card_button + ' ' + download_certificate_button;
                    return actions;
                }
            }
