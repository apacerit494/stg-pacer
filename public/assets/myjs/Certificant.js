...
$(document).ready(function () {
    ...
    $("#jqgrid_data").jqGrid({
        url: site_url + '/Certificant/jqgrid_user',
        mtype: "GET",
        datatype: "json",
        postData: {
        ...
        colModel: [
            ...
            { label: 'Full Name', name: 'full_name', width: 200, search: true, searchoptions: { sopt: ['cn'] } },
            { label: 'Birth Place', name: 'birth_place', width: 150, align: 'left', hidden: true },
            { label: 'Birth Date', name: 'birth_date', width: 150, align: 'center', hidden: true },
            {
                label: 'Gender', name: 'gender', width: 150, align: 'center', hidden: true, formatter: function (cellvalue) {
                    switch (cellvalue) {
                        case "P":
                            return "Pria";
                            break;
            ...
            { label: 'Address', name: 'address', width: 400 , hidden:true},
            { label: 'Province', name: 'province_name', width: 150, hidden: true },
            { label: 'District', name: 'district_name', width: 150, hidden: true },
            { label: 'Sub District', name: 'subdistrict_name', width: 150, hidden: true },
            { label: 'Village', name: 'village_name', width: 150, hidden: true },
            { label: 'Email', name: 'email', width: 250 },
            { label: 'Mobile Phone', name: 'mobile_phone', width: 150, hidden: false },
            { label: 'Status', name: 'keterangan', width: 200 },
            { label: 'Phone', name: 'phone', width: 150, hidden: true },
            { label: 'User Type', name: 'user_type_id', width: 150, hidden: true },
            { label: 'Id Card Number', name: 'idcard_number', width: 150 , hidden: true},
            { label: 'ID Card Path', name: 'doc_idcard_path', width: 150 , hidden: true},
            ...
            { label: 'Upadted At', name: 'updatedAt', width: 150, align: 'center' , hidden: true }
    ...
    $('#btn_edit').click(function (e) {
        ...
        if (selrow) {
            $.ajax({
                type: "POST", dataType: "json", data: { id: selrow },
                url: site_url + '/Certificant/check_status_certification_by_id',
                success: function (response) {
                    if (response.success === true) {
                        $.ajax({
                            type: "POST", dataType: "json", data: { id: selrow },
                            ...
                            success: function (response) {
                                $('#jqgrid').hide();
                                $('#register').show();
                                $('#user_id', FormPersonal).val(response.id);
                                $('#user_id_1', $('#FormAudit_1')).val(response.id);
                                $('#user_id_1', $('#FormEducation_1')).val(response.id);
                                $('#user_id_1', $('#FormExperience_1')).val(response.id);
                                $('#user_id_1', $('#FormTraining_1')).val(response.id);
                                $('#old_password', FormPersonal).val(response.password_hash);
                                ...
                                $('#village_id', FormPersonal).val(response.village_id);
                                $('#username', FormPersonal).val(response.username);
                                ...
                                $('#username', $('#FormPersonal')).attr('disabled', 'true');
                                ...
                                $.ajax({
                                    type: "POST",
                                    url: site_url + '/Certificant/get_data_education_by_id',
                                    data: { id: selrow },
                                    dataType: "json",
                                    success: function (response) {
                                        // if (count(response) > 0) {
                                ...
                                $.ajax({
                                    type: "POST",
                                    url: site_url + '/Certificant/get_data_experience_by_id',
                                    data: { id: selrow },
                                    dataType: "json",
                                    success: function (response) {
                                        // if (count(response) > 0) {
                                        ...
                                        for (iexperience in response) {
                                            ...
                                            $('#user_id_' + edu, $('#FormExperience_' + edu)).val(response[iexperience].user_id);
                                            ...
                                            $('#company_addres_' + edu, $('#FormExperience_' + edu)).val(response[iexperience].company_addres);
                                            ...
                                            $('#company_addres_' + edu, $('#FormExperience_' + edu)).attr('disabled', 'true');
                                ...
                                $.ajax({
                                    type: "POST",
                                    url: site_url + '/Certificant/get_data_audit_experience_by_id',
                                    data: { id: selrow },
                                    dataType: "json",
                                    success: function (response) {
                                        // if (count(response) > 0) {
                                        ...
                                        for (iaudit in response) {
                                            ...
                                            $('#user_id_' + edu, $('#FormAudit_' + edu)).val(response[iaudit].user_id);
                                            $('#id_' + edu, $('#FormAudit_' + edu)).val(response[iaudit].audit_experience_id);
                                            $('#company_name_' + edu, $('#FormAudit_' + edu)).val(response[iaudit].company_name);
                                            ...
                                            fill_multi_check('audit_experienced_scope', 'scope_id', "audit_experience_id='" + $('#id_' + edu, auditku).val() + "'", 'ref_scope', 'scope_id', 'scope_description', $('#scopean_' + edu, auditku), 'scope_id_', edu, 'disabled');
                                            ...
                                            fill_peran($('#role_id_' + edu), response[iaudit].role_id)
                                ...
                                $.ajax({
                                    type: "POST",
                                    url: site_url + '/Certificant/get_data_training_by_id',
                                    data: { id: selrow },
                                    dataType: "json",
                                    success: function (response) {
                                        // if (count(response) > 0) {
                                        ...
                                        for (itraining in response) {
                                            ...
                                            $('#user_id_' + edu, $('#FormTraining_' + edu)).val(response[itraining].user_id);
    ...
    $('#btn_edit', $('#FormPersonal')).click(function (e) {
        ...
        if ((caption_personal).trim() == 'Edit') {
            ...
            $('#username', $('#FormPersonal')).removeAttr('disabled');
    ...
    var clik_body_education = function () {
        ...
        html += '<form class="form-horizontal" role="form" method="post" id="FormEducation_' + jumlah_education + '" action="/Certificant/add_education/' + jumlah_education + '">';
        html += '<?= csrf_field() ?>';
    ...
    var click_body_experience = function () {
        ...
        html += '<form class="form-horizontal" role="form" method="post" id="FormExperience_' + jumlah_experience + '"  action="/Certificant/add_experience/' + jumlah_experience + '">';
    ...
    var disabled_form_experience = function (status, jumexp) {
        if (status == 'disabled') {
            ...
            $('#company_addres_' + jumexp, $('#FormExperience_' + jumexp)).removeAttr('disabled');
    ...
    var click_body_audit = function () {
        ...
        html += '<form class="form-horizontal" role="form" method="post" id="FormAudit_' + jumlah_audit + '" action="' + site_url + '/Certificant/add_audit_experience/' + jumlah_audit + '">';
        html += '<?= csrf_field() ?>';
        html += '<div class="alert alert-error" style="display:none;">';
        html += '    <button class="close" data-dismiss="alert"></button>';
        html += '    You have some form errors. Please check below.';
    ...
    var click_body_training = function () {
        ...
        html += '<form class="form-horizontal" role = "form" method = "post" id = "FormTraining_' + jumlah_training + '" action = "' + site_url + '/Certificant/add_training/' + jumlah_training + '">';
        html += '<?= csrf_field() ?>';
        html += '<div class="alert alert-error" style="display:none;">';
        html += '<button class="close" data-dismiss="alert"></button>';
        html += 'You have some form errors. Please check below.';
