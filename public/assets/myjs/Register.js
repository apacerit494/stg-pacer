$(document).ready(function () {
    ...
    var fill_child = function (stable, sid, sselect, sid_child) {
        $.ajax({
            ...
            url: site_url + '/Certificant/get_child',
            async: false,
    ...
    $('#btn_edit', $('#FormPersonal')).click(function (e) {
        ...
        if ((caption_personal).trim() == 'Edit') {
            $('#full_name', $('#FormPersonal')).removeAttr('disabled', 'disabled');
            $('#province_id', $('#FormPersonal')).removeAttr('disabled', 'disabled');
            $('#subdistrict_id', $('#FormPersonal')).removeAttr('disabled', 'disabled');
            $('#birth_place', $('#FormPersonal')).removeAttr('disabled', 'disabled');
            $('#village_id', $('#FormPersonal')).removeAttr('disabled', 'disabled');
            $('#birth_date', $('#FormPersonal')).removeAttr('disabled', 'disabled');
            $('#gender', $('#FormPersonal')).removeAttr('disabled', 'disabled');
            $('#mobile_phone', $('#FormPersonal')).removeAttr('disabled', 'disabled');
            $('#address', $('#FormPersonal')).removeAttr('disabled', 'disabled');
            $('#phone', $('#FormPersonal')).removeAttr('disabled', 'disabled');
            $('#idcard_number', $('#FormPersonal')).removeAttr('disabled', 'disabled');;
            $('#district_id', $('#FormPersonal')).removeAttr('disabled', 'disabled');;
            $('#doc_idcard_path', $('#FormPersonal')).removeAttr('disabled', 'disabled');;
            $('#btn_save', $('#FormPersonal')).removeAttr('disabled', 'disabled');;
    ...
    $("body").on("click", ".add-more-education", function () {
        ...
        html += '<form class="form-horizontal" role="form" method="post" id="FormEducation_' + jumlah_education + '"   enctype="multipart/form-data" action="/Register/add_education/' + jumlah_education + '">';
        html += '<?= csrf_field() ?>';
        ...
        html += '<input type="hidden"   id="text_doc_path_education_' + jumlah_education + '" name="text_doc_path_education_' + jumlah_education + '">';
        ...
        html += '    <a id="btn_preview_' + jumlah_education + '" class="btn btn-primary" href="" target="_blank">Preview</a>';
        html += '</div>';
        html += '</div>';
        ...
        html += '<button class="btn btn-circle blue" id="btn_save_' + jumlah_education + '"><i class="fa fa-save"></i> Save</button>';
    ...
    var update_form_education_awal = function () {
                    ...
                    $('#FormEducation_' + jumedu).ajaxSubmit({
                        ...
                        success: function (response) {
                            if (response.success == true) {
                                ...
                                (response.text_doc_path_education == '1') ? $('#doc_path_education_' + jumedu, $('#FormEducation_' + jumedu)).addClass('is-invalid') : "";
                            }
                        },
                        error: function () {
                            Template.WarningAlert("Failed to Connect into Databases, Please Contact Your Administrator!");
        ...
        for (let jumedu = 1; jumedu <= jumlah_education; jumedu++) {
            $('#doc_path_education_' + jumedu, educationku).change(function (e) {
                ...
                reader.readAsDataURL(e.target.files[0]);
                // alert($(this).val());
                $('#text_doc_path_education_' + jumedu, educationku).val($(this).val());
            });
        }
                ...
                $('#FormEducation_' + jumlah_education).ajaxSubmit({
                    ...
                    success: function (response) {
                        if (response.success == true) {
                            ...
                            (response.text_doc_path_education == '1') ? $('#doc_path_education_' + jumlah_education, $('#FormEducation_' + jumlah_education)).addClass('is-invalid') : "";
    ...
    $("body").on("click", ".add-more-experience", function () {
        ...
        html += '   <form class="form-horizontal" role="form" method="post" id="FormExperience_' + jumlah_experience + '"    enctype="multipart/form-data" action="/Register/add_experience/' + jumlah_experience + '">';
        ...
        html += '           <input type="hidden" id="text_doc_path_experience_' + jumlah_experience + '" name="text_doc_path_experience_' + jumlah_experience + '">';
        html += '           <div class="form-group row">';
        ...
        html += '           <div class="col-sm-4">';
        html += '               <textarea name="company_addres_' + jumlah_experience + '" id="company_addres_' + jumlah_experience + '" class="form-control" placeholder="Silahkan isi alamat perusahaan"></textarea>';
        html += '           </div>';
        html += '       </div>';
        html += '       <div class="form-group row">';
        ...
        html += '   <div class="form-group row">';
        html += '       <label class="col-sm-2 control-label" style="text-align:right">End Date</label>';
        html += '       <div class="col-sm-4 until-now">';
        html += '           <div class="input-group">';
        ...
        html += '       <div class="col-sm-4">';
        html += '            <div class="input-group">';
        html += '                <input type="checkbox" name="check_until_now_' + jumlah_experience + '" id="check_until_now_' + jumlah_experience + '" > &nbspUntil Now';
        html += '            </div>';
        html += '        </div>';
        html += '   </div>';
        html += '   <div class="form-group row  until-now">';
        ...
        html += '       </div>';
        html += '       <div class="com-sm-2">';
        html += '           <a id="btn_preview_' + jumlah_experience + '" class="btn btn-primary" href="" target="_blank">Preview</a>';
        html += '       </div>';
        html += '   </div>';
        html += '   <div class="form-actions">';
        html += '       <div class="form-group row">';
        html += '           <label class="col-md-2 control-label"></label>';
        html += '           <div class="col-md-4">';
        html += '               <button class="btn btn-circle blue" id="btn_save_' + jumlah_experience + '"><i class="fa fa-save"></i> Save</button>';
    ...
    var update_form_experience_awal = function () {
                            ...
                            if (response.success == true) {
                                $.alert({
                                    ...
                                    confirm: function () {
                                        ...
                                        $('#company_addres_' + jumexp, $('#FormExperience_' + jumexp)).attr("disabled", "true");
                                ...
                                (response.company_addres == '1') ? $('#company_addres_' + jumexp, $('#FormExperience_' + jumexp)).addClass('is-invalid') : "";
                                ...
                                (response.text_doc_path_experience == '1') ? $('#doc_path_experience_' + jumexp, $('#FormExperience_' + jumexp)).addClass('is-invalid') : "";
        ...
        for (let ejumexp = 1; ejumexp <= jumlah_experience; ejumexp++) {
            $('#btn_edit_' + ejumexp, $('#FormExperience_' + ejumexp)).click(function (e) {
                ...
                if ((caption_experience).trim() == 'Edit') {
                    ...
                    $('#company_addres_' + ejumexp, $('#FormExperience_' + ejumexp)).removeAttr('disabled');
                    ...
                    $('#check_until_now_' + ejumexp, $('#FormExperience_' + ejumexp)).removeAttr('disabled');
                    ...
                    $('#company_addres_' + ejumexp, $('#FormExperience_' + ejumexp)).attr('disabled', 'true');
                    ...
                    $('#check_until_now_' + ejumexp, $('#FormExperience_' + ejumexp)).attr('disabled', 'true');
        ...
        for (let jumexp = 1; jumexp <= jumlah_experience; jumexp++) {
            $('#doc_path_experience_' + jumexp, $('#FormExperience_' + jumexp)).change(function (e) {
                ...
                reader.readAsDataURL(e.target.files[0]);
                $('#text_doc_path_experience_' + jumexp, $('#FormExperience_' + jumexp)).val($('#doc_path_experience_' + jumexp, $('#FormExperience_' + jumexp)).val())

            });
        }

        for (let jumexp = 1; jumexp <= jumlah_experience; jumexp++) {
            $('#check_until_now_' + jumexp, $('#FormExperience_' + jumexp)).click(function () {
                //e.preventDefault();
                checkbox1 = document.getElementById("check_until_now_" + jumexp);
                if (checkbox1.checked) {
                    $('.until-now', $('#FormExperience_' + jumexp)).hide();
                } else {
                    $('.until-now', $('#FormExperience_' + jumexp)).show();
                }
            });
        }
    ...
    var update_form_experience_akhir = function () {
                        ...
                        if (response.success == true) {
                            $.alert({
                                ...
                                confirm: function () {
                                    ...
                                    $('#company_addres_' + jumlah_experience, $('#FormExperience_' + jumlah_experience)).attr("disabled", "true");
                            ...
                            (response.company_addres == '1') ? $('#company_addres_' + jumlah_experience, $('#FormExperience_' + jumlah_experience)).addClass('is-invalid') : "";
                            ...
                            (response.text_doc_path_experience == '1') ? $('#doc_path_experience_' + jumlah_experience, $('#FormExperience_' + jumlah_experience)).addClass('is-invalid') : "";
        ...
        $('#btn_edit_' + jumlah_experience, $('#FormExperience_' + jumlah_experience)).click(function (e) {
            ...
            if ((caption_experience).trim() == 'Edit') {
                ...
                $('#company_addres_' + jumlah_experience, $('#FormExperience_' + jumlah_experience)).removeAttr('disabled');
        ...
        $('#doc_path_experience_' + jumlah_experience, $('#FormExperience_' + jumlah_experience)).change(function (e) {
            ...
            reader.readAsDataURL(e.target.files[0]);
            $('#text_doc_path_experience_' + jumlah_experience, $('#FormExperience_' + jumlah_experience)).val($(this).val());
        });
    ...
    $("body").on("click", ".add-more-audit", function () {
        ...
        html += '<form class="form-horizontal" role="form" method="post" id="FormAudit_' + jumlah_audit + '"  enctype="multipart/form-data" action="' + site_url + '/Register/add_audit_experience/' + jumlah_audit + '">';
        html += '<?= csrf_field() ?>';
        html += '<div class="alert alert-error" style="display:none;">';
        html += '    <button class="close" data-dismiss="alert"></button>';
        html += '    You have some form errors. Please check below.';
        ...
        html += '    <input type="hidden"  id="doc_audit_' + jumlah_audit + '" name="doc_audit_' + jumlah_audit + '">';
        html += '    <input type="hidden"  id="doc_work_' + jumlah_audit + '" name="doc_work_' + jumlah_audit + '">';
        html += '    <div class="form-group row">';
        html += '        <label class="col-sm-2 control-label" style="text-align:right">Company Name</label>';
        html += '        <div class="col-sm-4">';
        html += '            <input type="text" name="company_name_' + jumlah_audit + '" id="company_name_' + jumlah_audit + '" class="form-control" placeholder="Silahkan isi nama perusahaan">';
        html += '        </div>';
        html += '        <div class="col-md-6">';
        ...
        html += '        <div class="col-md-6" id="scopean_' + jumlah_audit + '">';
        ...
        html += '              <div class="col-md-4" id="peranan_' + jumlah_audit + '">';
        html += '                  <select name="role_id_' + jumlah_audit + '" id="role_id_' + jumlah_audit + '"  class="form-control">';
        // html += '                      <option value="">Please Select</option>
        //html += '                      <?php foreach ($perans as $peran) : ?>
        //html += '                      <option value="<?php echo  $peran['role_id'] ?>">&nbsp<?php echo $peran['role_name']  ?></option>
        //html += '                      <?php endforeach; ?>
        html += '                  </select>';
        html += '              </div>';
        html += '          </div>';
        ...
        html += '    </div>';
        html += '    <div class="form-group row">';
        html += '        <label class="col-sm-2 control-label" style="text-align:right">Upload Audit Plan  & Attendance List</label>';
        html += '        <div class="col-sm-4">';
        ...
        html += '        </div>';
        html += '        <div class="com-sm-2">';
        html += '           <a id="btn_preview_audit_' + jumlah_audit + '" name="btn_preview_audit_' + jumlah_audit + '" class="btn btn-primary" href="#safaf" target="_blank">Preview</a>';
        html += '        </div>';
        html += '    </div>';
        html += '    <div class="form-group row">';
        ...
        html += '        </div>';
        html += '        <div class="com-sm-2">';
        html += '           <a id="btn_preview_work_' + jumlah_audit + '" name="btn_preview_work_' + jumlah_audit + '" class="btn btn-primary" href="#asdfsadf" target="_blank">Preview</a>';
        html += '        </div>';
        html += '    </div>';
        html += '    <hr>';
        html += '    <div class="form-actions">';
        ...
        html += '            <label class="col-md-2 control-label"></label>';
        html += '            <div class="col-md-4">';
        html += '                <button class="btn btn-circle blue" id="btn_save_' + jumlah_audit + '"><i class="fa fa-save"></i> Save</button>';
        ...
        fill_multi_check('audit_experienced_scope', 'scope_id', "audit_experience_id='" + $('#id_' + jumlah_audit, auditku).val() + "'", 'ref_scope', 'scope_id', 'scope_code,scope_description', $('#scopean_' + jumlah_audit, auditku), 'scope_id_', jumlah_audit);
        fill_peran($('#role_id_' + jumlah_audit, auditku), '');
    ...
    var disabled_form_audit = function (status, jumaud) {
        if (status == 'disabled') {
            $('#company_name_' + jumaud, $('#FormAudit_' + jumaud)).attr('disabled', 'true');
            ...
            $('#role_id_' + jumaud, $('#FormAudit_' + jumaud)).attr('disabled', 'true');
            ...
            $('.test1_' + jumaud).attr('disabled', 'true');

        } else {
            $('#company_name_' + jumaud, $('#FormAudit_' + jumaud)).removeAttr('disabled', 'disabled');
            ...
            $('#role_id_' + jumaud, $('#FormAudit_' + jumaud)).removeAttr('disabled', 'disabled');
    ...
    var update_form_audit_awal = function () {
                    ...
                    $('#FormAudit_' + jumaud).ajaxSubmit({
                        ...
                        success: function (response) {
                            if (response.success == true) {
                                $.alert({
                                    title: 'Success', icon: 'fa fa-check', backgroundDismiss: false,
                                    content: 'Update Audit Experience Success.' + response.id,
                                    confirmButtonClass: 'btn-success',
                                    confirm: function () {
                                ...
                                Template.WarningAlert(response.msg);
                                (response.company_name == '1') ? $('#company_name_' + jumaud, $('#FormAudit_' + jumaud)).addClass('is-invalid') : "";
                                ...
                                (response.doc_audit == '1') ? $('#doc_audit_plan_path_' + jumaud, $('#FormAudit_' + jumaud)).addClass('is-invalid') : "";
                                (response.doc_work == '1') ? $('#doc_work_order_path_' + jumaud, $('#FormAudit_' + jumaud)).addClass('is-invalid') : "";
        ...
        for (let jumaud = 1; jumaud <= jumlah_audit; jumaud++) {
            $('#doc_audit_plan_path_' + jumaud, auditku).change(function (e) {
                ...
                reader.readAsDataURL(e.target.files[0]);
                $('#doc_audit_' + jumaud, auditku).val($(this).val());
            });
        }
        ...
        for (let jumaud = 1; jumaud <= jumlah_audit; jumaud++) {
            $('#doc_work_order_path_' + jumaud, auditku).change(function (e) {
                ...
                reader.readAsDataURL(e.target.files[0]);
                $('#doc_work_' + jumaud, auditku).val($(this).val());
            });
        }
    }
                ...
                $('#FormAudit_' + jumlah_audit).ajaxSubmit({
                    ...
                    success: function (response) {
                        if (response.success == true) {
                            ...
                            Template.WarningAlert(response.msg);
                            (response.company_name == '1') ? $('#company_name_' + jumlah_audit, $('#FormAudit_' + jumlah_audit)).addClass('is-invalid') : "";
                            ...
                            (response.doc_audit == '1') ? $('#doc_audit_plan_path_' + jumlah_audit, $('#FormAudit_' + jumlah_audit)).addClass('is-invalid') : "";
                            (response.doc_work == '1') ? $('#doc_work_order_path_' + jumlah_audit, $('#FormAudit_' + jumlah_audit)).addClass('is-invalid') : "";
                                    ...
                                    $.alert({
                                        ...
                                        confirm: function () {
                                            if (sisa_audit == 0) {
                                                ...
                                                $('#btn_edit_' + jumlah_audit).parents(".tambahan_" + jumlah_audit).remove();
                                                sisa_audit--;
                                            }
    ...
    $("body").on("click", ".add-more-training", function () {
        ...
        html += '<form class="form-horizontal" role = "form" method = "post" id = "FormTraining_' + jumlah_training + '" enctype="multipart/form-data" action = "' + site_url + '/Register/add_training/' + jumlah_training + '">';
        html += '<?= csrf_field() ?>';
        html += '<div class="alert alert-error" style="display:none;">';
        html += '<button class="close" data-dismiss="alert"></button>';
        html += 'You have some form errors. Please check below.';
        ...
        html += '<input type="hidden" id="text_doc_path_training_' + jumlah_training + '" name="text_doc_path_training_' + jumlah_training + '">';
        html += '<div class="form-group row">';
        ...
        html += '</div>';
        html += '<div class="com-sm-2">';
        html += '    <a id="btn_preview_' + jumlah_training + '" name="btn_preview_' + jumlah_training + '" class="btn btn-primary" href="" target="_blank">Preview</a>';
        html += '</div>';
        html += '</div>';
        ...
        html += '<label class="col-md-2 control-label"></label>';
        html += '<div class="col-md-4">';
        html += '<button class="btn btn-circle blue" id="btn_save_' + jumlah_training + '"><i class="fa fa-save"></i> Save</button>';
    ...
    var update_form_training_awal = function () {
                    ...
                    $('#FormTraining_' + jumtra).ajaxSubmit({
                        ...
                        success: function (response) {
                            if (response.success == true) {
                                ...
                                (response.text_doc_path_training == '1') ? $('#doc_path_training_' + jumtra, $('#FormTraining_' + jumtra)).addClass('is-invalid') : "";
        ...
        for (let jumtra = 1; jumtra <= jumlah_training; jumtra++) {
            $('#doc_path_training_' + jumtra, trainingku).change(function (e) {
                ...
                reader.readAsDataURL(e.target.files[0]);
                $('#text_doc_path_training_' + jumtra, trainingku).val($(this).val());
    ...
    var update_form_training_akhir = function () {
                ...
                $('#FormTraining_' + jumlah_training).ajaxSubmit({
                    ...
                    success: function (response) {
                        if (response.success == true) {
                            ...
                            (response.text_doc_path_training == '1') ? $('#doc_path_training_' + jumlah_training, $('#FormTraining_' + jumlah_training)).addClass('is-invalid') : "";
        ...
        $('#doc_path_training_' + jumlah_training, trainingku).change(function (e) {
            ...
            reader.readAsDataURL(e.target.files[0]);
            $('#text_doc_path_training_' + jumlah_training, trainingku).val($(this).val());
        });
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        for (i in response) {
                            ...
                            if (check == true) {
                                if (stable1 == 'audit_experienced_scope') {
                                    checkbox += '<input type="checkbox" class="test1_' + ijum + '" id="' + sid + ijum + '" name="' + sid + ijum + '[]" value="' + response[i].id + '"   " checked " ' + disabled + '>&nbsp' + response[i].scope_code + ' - ' + response[i].name + '<br>';
                                ...
                                if (stable1 == 'audit_experienced_scope') {
                                    checkbox += '<input type="checkbox" class="test1_' + ijum + '" id="' + sid + ijum + '" name="' + sid + ijum + '[]" value="' + response[i].id + '"  ' + disabled + '>&nbsp' + response[i].scope_code + ' - ' + response[i].name + '<br>';
    ...
    // if (isi == 'ada') {
    for (let jumaud = 1; jumaud <= jumlah_audit; jumaud++) {
        fill_multi_check('audit_experienced_scope', 'scope_id', "audit_experience_id='" + $('#id_' + jumaud, auditku).val() + "'", 'ref_scope', 'scope_id', 'scope_code,scope_description', $('#scopean_' + jumaud, auditku), 'scope_id_', jumaud, 'disabled');
    }

    var fill_peran = function (sselect, srole_id) {
        $.ajax({
            type: "POST",
            dataType: "json",
            data: {
            ...
            url: site_url + '/Certificant/get_perans',
            async: false,
            success: function (response) {
                opt = '<option value="">Please Select</option>';
                for (i in response) {
                    if (response[i].role_id.trim() == srole_id.trim()) {
                        opt += '<option value="' + response[i].role_id.trim() + '"  selected>' + response[i].role_name + '</option>';
                    } else {
                        opt += '<option value="' + response[i].role_id.trim() + '">' + response[i].role_name + '</option>';
    ...
    //fill_child('ref_province', $('#province_id', personalku).val(), $('#district_id', personalku), jk_district);
    //fill_child('ref_district', $('#district_id', personalku).val(), $('#subdistrict_id', personalku), jk_subdistrict);
